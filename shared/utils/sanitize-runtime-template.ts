 ...
 * контексту рендера. Панель чистит этим же приёмом только `intro`,
 * `sections[].body` и `content` (appspro, article-html-sanitize.js), так что
 * здесь стоит вторая линия: `dataTables`, FAQ и `gridCards` до сайта доходят
 * сырыми.
 *
